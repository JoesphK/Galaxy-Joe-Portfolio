...
export const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      toast({
        title: "Message compiled and sent.",
    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Interested in working with me? Connect to me through the links below.
          Or you can fill out a message down there:
        </p>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:youssef.bsh.likex@gmail.com"
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a href="https://www.linkedin.com/in/joesphelbishbishy" target="_blank">
                  <Linkedin />
                </a>
